...
const FilePicker = ({
  ...
  return (
    <div styleName="container">
      ...
      <div
        styleName={`file-picker ${error ? "error" : ""} ${
          dragged ? "drag" : ""
        }`}
      >
        ...
        {isChallengeBelongToTopgearGroup && (
          <div styleName="url-input-container">
            {invalidUrl && (
              <div styleName="invalid-url-message">* Invalid URL</div>
            )}
            <input
              styleName={invalidUrl ? "invalid" : ""}
              id="name"
              name="name"
              type="text"
              placeholder="URL"
      ...
      {error && <div styleName="error-container">{error}</div>}
    </div>
  );
};
