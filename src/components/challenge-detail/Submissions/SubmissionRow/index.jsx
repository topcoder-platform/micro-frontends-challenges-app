      ...
      <div styleName="row">
        {isMM ? (
          <div styleName="col-1 col">
            ...
            <div styleName="col">{provisionalRank || "-"}</div>
          </div>
        ) : null}
        ...
        <div styleName="col-3 col">
          <div styleName="col col-left">{getFinalReviewResult()}</div>
          <div styleName="col">{getInitialReviewResult()}</div>
        ...
        <div styleName="col-4 col">
          ...
          <a onClick={toggleHistory} onKeyPress={toggleHistory}>
            <span>
              <span styleName="text">History ({submissions.length})</span>
              {openHistory ? (
                <ArrowNext styleName="icon down" />
              ) : (
                <ArrowNext styleName="icon" />
              )}
            </span>
          </a>
        </div>
        ...
        <div styleName="history">
          <div>
            <div styleName="row no-border history-head">
              ...
              <div styleName="col-2 col">Submission</div>
              <div styleName="col-3 col">
                <div styleName="col" />
                <div styleName="col">Final</div>
                <div styleName="col">Provisional</div>
              </div>
              <div styleName={`col-4 col ${isMM ? "mm" : ""}`}>Time</div>
              {isMM && <div styleName="col-5 col">&nbsp;</div>}
            </div>
          </div>
