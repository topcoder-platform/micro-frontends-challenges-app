  ...
  render() {
    ...
    return (
      ...
      >
        {!isLoadingSubmissionInformation && (
          <React.Fragment>
            <div styleName="modal.submission-information-title">
              Advanced Details
            </div>
            {submissionBasicInfo ? (
              <div styleName="modal.submission-information-details">
                <div styleName="modal.submission-information-details-row1">
                  <span styleName="modal.submission-information-details-title">
                    Submission:&nbsp;
                  </span>
                  <span styleName="modal.submission-information-details-id">
            ...
            {testcases.length > 0 && (
              <React.Fragment>
                <div styleName="modal.testcase-title">Test cases executed</div>
                {_.map(testcases, (item, index) => (
                  <div
                    styleName="modal.testcase-items"
