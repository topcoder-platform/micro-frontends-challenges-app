...
import { getService } from "services/submissions";
...
import DownloadIcon from "../../../../assets/images/IconSquareDownload.svg";
  ...
  render() {
    ...
    return (
      <div styleName="wrapper">
        <article>
          <h2 styleName="h2">My Submissions</h2>
        </article>
        <div styleName="submission-table">
          ...
          <div styleName="submission-table-header submission-table-row">
            <div styleName="submission-table-column column-1">
              <div
                styleName={cn("submission-table-column column-1-1", {
              ...
              <div
                styleName={cn("submission-table-column column-1-2", {
            ...
            <div styleName="submission-table-column column-2">
              <div
                styleName={cn("submission-table-column column-2-1", {
              ...
              <div
                styleName={cn("submission-table-column column-2-2", {
              ...
              <div
                styleName={cn("submission-table-column column-2-3", {
          ...
          {sortedSubmissions.map((mySubmission) => {
            ...
            return (
              <div
                key={mySubmission.submissionId}
                styleName="submission-table-row"
              >
                <div styleName={cn("submission-table-column column-1")}>
                  <button
                    onClick={() => {
                ...
                <div styleName="submission-table-column column-2">
                  ...
                  >
                    <span>
                      {moment(mySubmission.submissionTime).format(
                        "DD MMM YYYY"
                      )}{" "}
                      {moment(mySubmission.submissionTime).format("HH:mm:ss")}
                    </span>
                  </div>
                  <div styleName="submission-table-column column-2-4">
                    <button
                      onClick={() => {
                        ...
                        submissionsService
                          .downloadSubmission(mySubmission.submissionId)
                          .then((blob) => {
                            ...
                            link.setAttribute(
                              "download",
                              `submission-${mySubmission.submissionId}.zip`
                            );
