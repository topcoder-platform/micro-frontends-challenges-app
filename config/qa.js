module.exports = {
  ...
  URL: {
    ...
    COMMUNITIES: {
      ...
      ZURICH: "https://community-app.topcoder-qa.com/__community__/zurich",
      COMCAST: "https://community-app.topcoder-qa.com/__community__/comcast",
      CS: "https://community-app.topcoder-qa.com/__community__/cs",
    },
    ...
    MEMBER: "https://members.topcoder-qa.com",
    ...
    TCO19: "https://community-app.topcoder-qa.com/__community__/tco19",
    ...
    EMAIL_VERIFY_URL:
      "http://www.topcoder-qa.com/settings/account/changeEmail",
    ABANDONMENT_EMBED:
  ...
  API: {
    V5: "https://api.topcoder-qa.com/v5", //"http://localhost:3030/api/v5"
